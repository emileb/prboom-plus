...
LOCAL_CFLAGS :=  -DHAVE_JWZGLES -DHAVE_LIBZ -DGL_DOOM -DUSE_SHADERS  -DENGINE_NAME=\"prboom\" -fsigned-char -DHAVE_DIRENT_H -DHAVE_CONFIG_H -Dstricmp=strcasecmp -DPRBOOM_DOOM
...
LOCAL_STATIC_LIBRARIES += jwzgles SDL2_net logwritter

LOCAL_SHARED_LIBRARIES := touchcontrols SDL2 SDL2_mixer SDL2_image core_shared saffal fluidsynth GL4ES
